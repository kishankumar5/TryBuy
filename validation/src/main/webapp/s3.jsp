                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop" style= "width:1210px;height:500px">
                                <div class="brand-box">
                                    ...
                                    <i><img src="icon/s3.jpg"/ style="width:700px">
                                </i>
...
Insert into Cart values(?,?,?);
	...
	<sql:param value="Asus ZenBook Pro"></sql:param>
	<sql:param value="99999"></sql:param>
</sql:update>
                            </div>
                            </div>
              ...
              <div class="card">
                ...
                <a href="" >
                  <strong class="card-text">
                    Product Name:<h1>Asus ZenBook Pro</h1>
                    <br>
                    Price :<h1>Rs.99999</h1>
                    <br>
