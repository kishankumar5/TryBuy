...
Insert into Cart values(?,?,?);
	...
	<sql:param value="Apple Airpods Pro"></sql:param>
	<sql:param value="28999"></sql:param>
</sql:update>
                            </div>
                            </div>
              ...
              <div class="card">
                ...
                <a href="" >
                  <strong class="card-text">
                    Product Name:<h1>Apple Airpods Pro</h1>
                    <br>
                    Price :<h1>Rs.28999</h1>
                    <br>
